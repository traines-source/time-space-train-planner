...
func (p *Timetables) prepareClient() {
	r := httptransport.New(os.Getenv("API_CACHE_HOST"), os.Getenv("DBOPEN_API_CACHE_PREFIX")+apiclient.DefaultBasePath, []string{os.Getenv("API_CACHE_SCHEME")})
	r.DefaultAuthentication = httptransport.BearerToken(os.Getenv("DBOPEN_API_ACCESS_TOKEN"))
